...
private:
	...
	WNDPROC pWndProcPtr;
public:
	MainWindowClass(HINSTANCE hInstance = NULL, LPCWSTR lpszReg = NULL, WNDPROC pWndProc = NULL) : hInstanceHandle{ hInstance }, lpszClassReg{ lpszReg }, pWndProcPtr{ pWndProc }, hWndHandle{ NULL }, WndClass{} {
